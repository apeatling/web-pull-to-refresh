var WebPullToRefresh = (function () {
	...
	var disable: function(){
		...
		h.get('panstart').set({ enable: false });
		h.get('pandown').set({ enable: false });
		h.get('panup').set({ enable: false });
		h.get('panend').set({ enable: false });
	}
	
	var enable: function(){
		var h = new Hammer( options.contentEl );
		h.get('pan').set({ enable: true });
		h.get('panstart').set({ enable: true });
		h.get('pandown').set({ enable: true });
		h.get('panup').set({ enable: true });
		h.get('panend').set({ enable: true });
	}
