var WebPullToRefresh = (function () {
	...
	var init = function( params ) {
		params = params || {};
		options = {
			contentEl: document.getElementById( params.contentEl ) || document.getElementById( defaults.contentEl ),
			ptrEl: document.getElementById( params.ptrEl ) || document.getElementById( defaults.ptrEl ),
